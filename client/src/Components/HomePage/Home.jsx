            ...
            <div className="relative min-h-screen w-full flex flex-col overflow-x-hidden dot-grid bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 antialiased">
                <main className="flex-1 flex flex-col items-center">
                    ...
                    <section className="w-full max-w-5xl px-6 pt-24 pb-16 text-center">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black text-slate-900 dark:text-white leading-[1.1] tracking-tight mb-6">Code-together</h1>
                        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 font-normal max-w-2xl mx-auto mb-10">
                            The fastest way to build together. A high-performance environment for pairing, debugging, and rapid prototyping.
                        </p>
                    </section>

                    {/* Interaction Section */}
                    <section className="w-full max-w-3xl px-6 py-7">
                        <Form />
                    </section>
                </main>
